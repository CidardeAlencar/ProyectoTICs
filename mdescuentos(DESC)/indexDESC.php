<?php
$obf_path = '../connection.php';
$obf_currentPath = dirname(__FILE__);
$obf_newPath = $obf_currentPath . DIRECTORY_SEPARATOR . $obf_path;
require_once $obf_newPath;
              ...
              <div class="col-md-3 col-sm-4">
                <div class="single-new-arrival">
                  <div class="single-new-arrival-bg">
                    <img src="<?= $obf_discountProduct['imagen'] != '' ? $obf_discountProduct['imagen'] : 'assets/images/collection/arrivals1.png' ?>" alt="new-arrivals images">
                    <div class="single-new-arrival-bg-overlay"></div>
                    <div class="sale bg-1" style="width:auto;">
                      <p><?= $obf_discountProduct['categoriaProducto'] ?></p>
                    </div>
                    <div class="sale bg-1">
                      <p><?= $obf_discountProduct['percentage'] ?>%</p>
                    </div>
                  ...
                  <h4><a href="#"><?= $obf_discountProduct['nombreProducto'] ?></a></h4>
                  <p class="arrival-product-price line-through" style="color: #ef4444;">$<?= $obf_discountProduct['precioProducto'] ?></p>
                  <p class="arrival-product-price" style="color: #0d9488;">$<?= $obf_discountProduct['precioProducto'] - ($obf_discountProduct['precioProducto'] * $obf_discountProduct['percentage'] / 100) ?></p>
                </div>
              </div>
              <?php endforeach; ?>
            </div>
