...
$currentDescuentoStmt = $connect->prepare( "SELECT * FROM descuentos WHERE id = ?" );
$currentDescuentoStmt->bind_param( 'i', $descuentoId );
$currentDescuentoStmt->execute();
$currentDescuentoResult = $currentDescuentoStmt->get_result();
$currentDescuento = $currentDescuentoResult->fetch_assoc();
...
if ( $_SERVER[ 'REQUEST_METHOD' ] === 'POST' ) {
  ...
  if ( $errorMessage === '' ) {
    ...
    try {
      $updateStmt->bind_param( "isssssii",
        $updateDto[ 'productId' ],
        $updateDto[ 'name' ],
      ...
      >
        ...
        <div class="mt-8">
          <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
            <form class="max-w-sm mx-auto" method="POST" action="editDESC.php?id=<?= $descuentoId ?>">
              <div class="mb-5">
                ...
                <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="productId">
                  ...
                  foreach ( $products as $product ) {
                    echo "<option value='{$product[ 'id_producto' ]}'" . ( $product[ 'id_producto' ] === $currentDescuento[ 'productId' ] ? ' selected' : '' ) . ">{$product[ 'nombre' ]}</option>";
                  }
                  ?>
                </select>
              </div>
              <div class="mb-5">
                ...
                <input
                  ...
                  value="<?= $name ?? $currentDescuento[ 'name' ] ?? '' ?>"
              ...
              <div class="mb-5">
                ...
                <input
                  ...
                  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                  name="description"
                  value="<?= $description ?? $currentDescuento[ 'description' ] ?? '' ?>"
              ...
              <div class="mb-5">
                ...
                <input
                  ...
                  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                  name="percentage"
                  value="<?= $percentage ?? $currentDescuento[ 'percentage' ] ?? '' ?>"
              ...
              <div class="mb-5">
                ...
                <input
                  ...
                  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                  name="fechaInicio"
                  value="<?= $fechaInicio ?? $currentDescuento[ 'fechaInicio' ] ?? date( 'Y-m-d' ) ?>"
                />
              </div>
              <div class="mb-5">
                <label
                ...
                <input
                  ...
                  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                  name="fechaFin"
                  value="<?= $fechaFin ?? $currentDescuento[ 'fechaFin' ] ?? date( 'Y-m-d' ) ?>"
                />
              </div>
              <?php if ( $errorMessage !== '' ) : ?>
              <div class="mb-5">
