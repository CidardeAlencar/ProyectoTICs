...
$this->SetTextColor(0, 0, 0);
$this->Cell(145, 8, utf8_decode('LISTADO DE PRODUCTOS'),0,1,"C");
...
$pdf->Cell(102, 12, utf8_decode('DESCRIPCION'),1,1,'C',1);
...
$consulta_reporte_alquiler = $conexion->query(" select * from productos ");
...
$pdf->Cell(58, 8, utf8_decode($datos_reporte->nombre),'B',0,'L',1);

$pdf->Cell(23, 8, utf8_decode($datos_reporte->cantidad),'B',0,'C',1);

$pdf->MultiCell(102, 8, utf8_decode($datos_reporte->descripcion), 'B', 'L', 1);
