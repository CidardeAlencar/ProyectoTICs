...
function Footer()
{
     $this->SetFont('helvetica', 'B', 8);
        ...
        $this->SetY(265);
        $this->Cell(0,5,utf8_decode("REPORTE S.R.L. © Todos los derechos reservados."),0,0,"C");
...
$consulta_reporte_alquiler = $conexion->query(" SELECT  c.nombre AS nombre_cliente,m.nombre  AS nombre_producto,mp.Fecha,mp.cantidad ,mp.Precio_Total
FROM ventas mp
