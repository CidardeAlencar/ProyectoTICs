<?php 
	...
	$per_page = 10;
		...
		if($orders->num_rows) {
						...
						$items .= "<tr>
									...
									<td>
										<select onChange=\"change_stat('".$oid."')\" id='".$oid."' name='status' class='form-control'>
											<option value='pending_$oid' >pendiente</option>
											<option value='confirmed_$oid' selected>confirmado</option>
										</select>
									</td>
									<th></th>
								</tr>";
			...
			$result = "Aún no hay pedidos disponibles.";
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">PEDIDOS</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title" style="text-align: center">Lista de Pedidos</h4>
                            </div>
