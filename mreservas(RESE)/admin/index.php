		...
		if(isset($_POST['submit'])) {
			...
			if($user != "" && $pass != "") {
				...
				if($verify->num_rows) {
					...
					echo "<script>alert('Credenciales de acceso invalidos. Inténtalo de nuevo.')</script>";
					
				}
				
			}else{
				
				echo "<script>alert('Algunos campos están vacíos. ¡Todos los campos deben ser llenados!')</script>";
...
<div class="login_wrapper">
	...
	<div class="login_holder">
		...
		<form method="post" action="index.php">
			...
			<div class="header">
				<h4 style="border-bottom: 1px solid #FF5722;" class="title">Inicio de Sesión</h4>
			</div>
			
			<div class="form-group" method="post" action="#">
				<label>Usuario</label>
				<input type="text" name="username" class="form-control" placeholder="Ingrese su Usuario" autofocus>
			</div>
