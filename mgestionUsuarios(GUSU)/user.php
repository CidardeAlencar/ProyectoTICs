...
<body>
    <div class="container">
        ...
        <div class="btn-container">
            <div>
                <button type="button" onclick="window.location.href= './registro_user.php' " >Nuevo usuario <i class="fa fa-plus"></i></button>
            </div>
            <div>
                    ...
                    while ($fila = mysqli_fetch_array($dato)) {
                        ...
                        <tr>
                            ...
                            <?php if ($fila['rol'] == 'admin') { ?>
                                <td>
                                    <center>
                                        <button class="editBtn" onclick="window.location.href = 'edit_user.php?id=<?php echo $fila['id']; ?>'">
                                ...
                                <td>
                                    <center>
                                        <div class="button-container">
                                            ...
                                            <a href="eliminar_user.php?id=<?php echo $fila['id']; ?>" class="bin-button">
