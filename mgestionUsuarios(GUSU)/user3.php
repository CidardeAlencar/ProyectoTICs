...
<style>
    .navbar2 {
    background-color: #e99c2e; /* Color de fondo del navbar */
    overflow: hidden;
...
.navbar2 a:hover {
    background-color: #d18822; /* Color de fondo al pasar el mouse */
}

</style>
<div class="navbar2">
    <a href="listar-usuarios.php">Listar Usuarios</a>
    <a href="activar-desactivar.php">Activar/Desactivar Usuario</a>
    <a href="editar-usuario.php">Editar Usuario</a>
    <a href="buscar-usuario.php">Buscar Usuario</a>
</div>
    <div class="container">
