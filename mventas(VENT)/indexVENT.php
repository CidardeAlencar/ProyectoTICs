...
// Consulta para obtener las ventas filtradas por el término de búsqueda
$consulta = "SELECT 
                VentaID, 
                Nombre, 
                Descripcion, 
...
<style>
	...
	#new-arrivals .button-container button:hover {
...
<body>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
							<ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
								...
								<li class="scroll"><a href="#new-arrivals">ventas</a></li>
    ...
    <form method="GET" action="">
        <input type="text" placeholder="Buscar por nombre..." name="buscar">
				...
				<table>
					...
					<tbody>
						...
						if ($resultado && mysqli_num_rows($resultado) > 0) {
							...
							echo "<tr><td colspan='7'>No se encontraron ventas.</td></tr>";
						}
						?>
					</tbody>
				</table>
