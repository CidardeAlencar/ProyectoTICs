...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre'])) {
    ...
    $query = mysqli_prepare($conexion, "SELECT categoria, precio FROM productos WHERE nombre = ?");
        ...
        <form id="payment-form" class="payment-form" method="POST">
            <div class="container">
                <div class="task">
                    ...
                    <div>
                        <label style="font-size: 100%; " for="nombre">Producto </label>
                    </div>
                    <div>
                        <select style="width: 100%;height: 40px;" name="nombre" id="nombre" onchange="this.form.submit()">
                            ...
                            $result = mysqli_query($con, "SELECT nombre FROM productos");
                    ...
                    <div>
                        <label style="font-size: 100%;" for="contratacion">Categoría del Producto </label>
                        <div>
                    ...
                    <div>
                        <label style="font-size: 100%;" for="correo">Precio del Producto </label>
                        <div>
                            <input type="text" name="correo" id="correo" value="<?php echo $correo; ?>" readonly>
                        </div>
                    </div>
                    <div>
                        <label style="font-size: 100%;" for="desempeno">Descripción del Producto </label>
                        <div>
                            <input style="width: 95%; height:25px; font-size: 90%" type="text" name="desempeno" placeholder="Descripción del Producto">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-payment">
                            <div>
                                <table border="1">
                                    ...
                                    <tr>
                                        <td style="text-align: center;padding-left: 0%; background-color: #e99c2e; color: white;" class="center-content; " colspan="5">Según Fecha de Nacimiento</td>

                                    </tr>
                                    <tr>
                                        <div>
                                            <label style="font-size: 100%;" for="desempeno">Fecha de vencimiento del producto </label>
                                            <div>
                                                <input style="width: 95%; height:25px; font-size: 90%" type="date" name="desempeno" >
                                            </div>
                                        </div>
                                    </tr>
                                    <tr>
                                        <td style="padding-left: 0%; background-color: #6666;">El producto se encuentra en la fecha establecida</td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 0%; background-color: #6666;">El producto ya se vendio de acuerdo a la fecha</td>
                            ...
                            <div>
                                <table border="1">
                                    <tr>
                                        <td style="text-align: center; padding-left: 0%; background-color: #e99c2e; color: white;" class="center-content; " colspan="5">Según la Calidad</td>

                                    </tr>
                                    <tr>
                                        <td style="padding-left: 0%; background-color: #6666;">El producto es de buena calidad su empaque </td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 0%; background-color: #6666;">El producto es de buena calidad la empresa de donde proviene</td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 0%; background-color: #6666;">El producto satisface a los clientes en su compra</td>
